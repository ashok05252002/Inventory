  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-12">
      ...
      <div className="flex items-center gap-2 text-sm font-medium text-slate-500">
        ...
        <span>/</span>
        <span className="text-slate-800">{id || 'SUPP-1001'}</span>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Global Parts Inc.</h1>
          ...
          <p className="text-slate-500 mt-2 font-medium">Supplier Code: <span className="font-bold text-slate-700">{id || 'SUPP-1001'}</span></p>
        </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-10 bg-slate-50 border border-dashed border-slate-200 rounded-xl">
            ...
            <p className="text-slate-500 font-medium">No recent purchase orders found for this supplier.</p>
          </div>
        </CardContent>
      </Card>
    </div>
